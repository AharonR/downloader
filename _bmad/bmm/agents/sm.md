...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="EAF or fuzzy match on epic-auto-flow" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/epic-auto-flow/workflow.yaml">[EAF] Run auto-flow pipeline for one epic (create-story -> party-mode-audit -> dev-story -> code-review)</item>
