...
pub use auth::{
    CaptureError, CapturedCookieFormat, CapturedCookies, CookieError, CookieLine, StorageError,
    clear_persisted_cookies, load_cookies_into_jar, load_persisted_cookies,
    load_runtime_cookie_jar, parse_captured_cookies, parse_netscape_cookies, persisted_cookie_path,
    rotate_key, store_persisted_cookies, unique_domain_count,
};
